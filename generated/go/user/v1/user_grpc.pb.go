...
const (
	...
	AuthService_GetRefreshToken_FullMethodName = "/user.v1.AuthService/GetRefreshToken"
	AuthService_GetAccessToken_FullMethodName  = "/user.v1.AuthService/GetAccessToken"
)

...
var file_user_proto_rawDesc = string([]byte{
	...
	0x65, 0x72, 0x2e, 0x76, 0x31, 0x22, 0x40, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73,
	...
	0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68,
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73,
	...
	0x12, 0x1e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x63,
...
var file_user_proto_goTypes = []any{
	...
	(*GetRefreshTokenRequest)(nil),  // 4: user.v1.GetRefreshTokenRequest
	(*GetRefreshTokenResponse)(nil), // 5: user.v1.GetRefreshTokenResponse
	(*GetAccessTokenRequest)(nil),   // 6: user.v1.GetAccessTokenRequest
	(*GetAccessTokenResponse)(nil),  // 7: user.v1.GetAccessTokenResponse
}
var file_user_proto_depIdxs = []int32{
	0, // 0: user.v1.AuthService.Login:input_type -> user.v1.LoginRequest
	2, // 1: user.v1.AuthService.Register:input_type -> user.v1.RegisterRequest
	4, // 2: user.v1.AuthService.GetRefreshToken:input_type -> user.v1.GetRefreshTokenRequest
	6, // 3: user.v1.AuthService.GetAccessToken:input_type -> user.v1.GetAccessTokenRequest
	1, // 4: user.v1.AuthService.Login:output_type -> user.v1.LoginResponse
	3, // 5: user.v1.AuthService.Register:output_type -> user.v1.RegisterResponse
	5, // 6: user.v1.AuthService.GetRefreshToken:output_type -> user.v1.GetRefreshTokenResponse
	7, // 7: user.v1.AuthService.GetAccessToken:output_type -> user.v1.GetAccessTokenResponse
